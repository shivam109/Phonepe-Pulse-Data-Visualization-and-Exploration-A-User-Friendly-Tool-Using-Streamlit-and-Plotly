...
icon = Image.open(
    "C:/Users/acer/Desktop/phonePe/Phonepe_Pulse_Data_Visualization-main/Data/ICN.png")
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By SHIVAM",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Shivam*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(
                'C:/Users/acer/Desktop/phonePe/Phonepe_Pulse_Data_Visualization-main/Data/Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://www.linkedin.com/in/shivam-7094911b1/")
        st.write("https://github.com/shivam109?tab=repositories")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        image_path = "images/Pulseimg.jpg"
        st.image(image_path, use_column_width=True)
